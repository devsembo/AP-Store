        ...
        <div class="col-md-10">
            ...
            <div class="row">
                ...
                <div class="col text-end">
                    <div class="text-center p-3 my-2 badge bg-primary status-clicavel" onclick="apresentarModal()"><?= $encomenda->status ?></div>
                    <?php if ($encomenda->status == 'EM PROCESSAMENTO') : ?>
                        <div classs="m-2">
                            <a href="?a=criar_pdf_encomenda&e=<?= core\classes\Store::aesEncriptar($encomenda->id_encomenda) ?>" class="btn btn-primary btn-sm">Ver PDF</a>
                            <a href="?a=enviar_pdf_encomenda&e=<?= core\classes\Store::aesEncriptar($encomenda->id_encomenda) ?>" class="btn btn-primary btn-sm">Enviar PDF</a>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
                ...
                <tbody>
                    <?php foreach ($lista_produtos as $produto) : ?>
                        <tr>
                            ...
                            <td class="text-end"><?= preg_replace("/\./", ",", $produto->preco_unidade) . ' kzs' ?></td>
