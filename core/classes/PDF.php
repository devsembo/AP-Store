...
class PDF 
{
    ...
    public function guardar_pdf($nome_ficheiro)
    {
        // guardar ficheiro pdf com o nome pretendido 
        $this->pdf->WriteHTML($this->html);
    ...
    // =============================================================================
    public function set_permissoes($permissoes = [])
    {
        // define permissões para o documento aser enviado
